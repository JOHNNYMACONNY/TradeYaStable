import{g as w,F as y,_ as I,C,r as g}from"./firebase-DF8VjN5J.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x="auth-internal",M="app-check-internal",$="messaging-internal";function G(e,t){const n=(r,{instanceIdentifier:i})=>{const o=r.getProvider("app").getImmediate(),s=r.getProvider(x),a=r.getProvider($),l=r.getProvider(M);return new v(o,s,a,l,i,e)};I(new C(A,n,"PUBLIC").setMultipleInstances(!0)),g(T,E,t),g(T,E,"esm2017")}function V(e,t,n){return L(w(e),t,n)}G(fetch.bind(self));export{V as httpsCallable};
//# sourceMappingURL=index.esm-DAbzv-F7.js.map
