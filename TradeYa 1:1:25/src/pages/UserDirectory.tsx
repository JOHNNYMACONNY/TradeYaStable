...
import { Search, Tag, MessageSquare, ExternalLink, UserPlus, Check, Clock } from 'lucide-react';
        ...
        {filteredUsers.map((profile) => (
          <div key={profile.id} className="card p-6">
            ...
            <div className="mt-4 pt-4 border-t border-earth-700 flex gap-2">
              ...
              ) : connectionStatuses[profile.id] === 'pending' ? (
                <button
                  disabled
                  className="flex-1 btn-secondary flex items-center justify-center gap-2 opacity-75"
                >
